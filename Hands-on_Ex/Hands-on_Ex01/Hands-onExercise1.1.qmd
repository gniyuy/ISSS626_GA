...
```{r}
cyclingpath = st_read(dsn = "C:/gniyuy/ISSS626_GA/Hands-on_Ex/Hands-on_Ex01/Data/Geospatial", 
...
```{r}
preschool = st_read("C:/gniyuy/ISSS626_GA/Hands-on_Ex/Hands-on_Ex01/Data/Geospatial/PreSchoolsLocation.kml")
```
...
```{r}
listings <- read_csv("C:/gniyuy/ISSS626_GA/Hands-on_Ex/Hands-on_Ex01/Data/Aspatial/listings.csv")
```
