...
```{r}
mpsz <- st_read(dsn = "C:/gniyuy/ISSS626_GA/Hands-on_Ex/Hands-on_Ex01/Data/Geospatial", 
...
This behavior occurs because R is designed to provide a quick preview of the dataset rather than printing the entire content, which might be too large to display in the console or output. This preview helps to give an overview of the dataset without overwhelming the user with too much information at once.
...
```{r}
popdata <- read_csv("C:/gniyuy/ISSS626_GA/Hands-on_Ex/Hands-on_Ex01/Data/Aspatial/respopagesextod2011to2020.csv")
```

### Data Preparation

Before a thematic map can be prepared, we can prepare a data table with year 2020 values. The data table should include the variables PA, SZ, YOUNG, ECONOMY ACTIVE, AGED, TOTAL, DEPENDENCY.
...
```{r}
write_rds(mpsz_pop2020, "C:/gniyuy/ISSS626_GA/Hands-on_Ex/Hands-on_Ex02/Data/rds/mpszpop2020.rds")
```
