...
```{r}
network <- st_read(dsn="C:/gniyuy/ISSS626_GA/Hands-on_Ex/Hands-on_Ex03/Data/Geospatial", 
                   layer="Punggol_St")
```

```{r}
childcare <- st_read(dsn="C:/gniyuy/ISSS626_GA/Hands-on_Ex/Hands-on_Ex03/Data/Geospatial",
                     layer="Punggol_CC")
```
...
Verify that the structure of `childcare3414` matches what the NKDE function expects.

```{r}
childcare3414 <- st_zm(childcare)
```
